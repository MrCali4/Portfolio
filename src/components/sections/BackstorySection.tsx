...
export const BackstorySection = () => {
  return (
    <section id="backstory" className="relative py-20 md:py-24 px-5 md:px-6 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-electric-500/5 pointer-events-none" />
      <div className="absolute top-20 left-10 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-primary/10 rounded-full blur-3xl animate-pulse opacity-30 sm:opacity-40" />
      <div className="absolute bottom-20 right-10 w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-electric-500/10 rounded-full blur-3xl animate-pulse opacity-30 sm:opacity-40" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 gap-10 md:gap-12 lg:grid-cols-3 lg:gap-12 mb-16">
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-to-br from-electric-500/20 to-primary/20 backdrop-blur-xl border-electric-500/30 hover:border-electric-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-electric-500/25 relative overflow-hidden animate-fade-in" style={{ animationDelay: '500ms' }}>
              ...
              <CardContent className="p-7 sm:p-8 text-center relative z-10">
